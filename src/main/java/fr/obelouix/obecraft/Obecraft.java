...
public class Obecraft {
    ...
    public static final String MODID = "obecraft";
    ...
    @SubscribeEvent
    @OnlyIn(Dist.CLIENT)
    public void modMessages(TickEvent.PlayerTickEvent event) {
        if (ModList.get().isLoaded("jei") && !Config.isRemoveRecipeButton() && !jeiEnabledWarn) {
            String modName = TextFormatting.GOLD + "JEI" + TextFormatting.RESET;
