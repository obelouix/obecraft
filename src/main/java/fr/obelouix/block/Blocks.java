...
import fr.obelouix.util.Rarity;
...
import static fr.obelouix.util.Rarity.GREEN;
...
public class Blocks {
    ...
    {
        Registry.register(Registry.ITEM, new Identifier("obecraft", "uranium_ore"), new BlockItem(URANIUM_ORE, new Item.Settings().group(ItemGroup.BUILDING_BLOCKS).maxDamage(200)));
    }
}
