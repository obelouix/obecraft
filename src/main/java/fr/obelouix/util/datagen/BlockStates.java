...
public class BlockStates extends BlockStateProvider {
    ...
    public BlockStates(DataGenerator gen, ExistingFileHelper exFileHelper) {
        super(gen, Obecraft.MODID, exFileHelper);
    }

    @Override
    protected void registerStatesAndModels() {
        simpleBlock(BlockRegistry.BIRCH_WORKBENCH.get());
//        registerFirstBlock();
//        registerComplexMultipart();
    }
/*
    private void registerFirstBlock() {
        ResourceLocation txt = new ResourceLocation(Obecraft.MODID, "block/firstblock");
        BlockModelBuilder modelFirstblock = models().cube("firstblock", txt, txt, new ResourceLocation(Obecraft.MODID, "block/firstblock_front"), txt, txt, txt);
        BlockModelBuilder modelFirstblockPowered = models().cube("firstblock_powered", txt, txt, new ResourceLocation(Obecraft.MODID, "block/firstblock_powered"), txt, txt, txt);
        orientedBlock(BlockRegistry.FIRSTBLOCK.get(), state -> {
    ...
    private void registerComplexMultipart() {
        ...
        createDimensionalCellModel(BlockRegistry.COMPLEX_MULTIPART.get(), dimCellFrame);
    }
